...
class Plant():
	...
	def __init__(self, name: str, height: float, age: int, growth: float, show: bool = True) -> None:
		self._name = name
	...
	def pass_days(self, days: int, period: str = "period", show: bool = True) -> None:
		if show:
			self.show()
...
class Tree(Plant):
	...
	def produce_shade(self):
		...
		print(f"Tree {self._name} now produces a shade of {self._trunk_diameter}cm long and {self._height}cm wide.")
